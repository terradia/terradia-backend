      ...
      async (
        ...
        if (company) {
          ...
          if (args.cover) {
            ...
            uploadToS3SaveAsProductCover(filename, stream, company.id, product.id);
          }
    ...
    updateProduct: combineResolvers(
      ...
      async (
        ...
        if (args.cover) {
          ...
          const { stream, filename } = await args.cover;
          uploadToS3SaveAsProductCover(filename, stream, existingProduct.companyId , args.productId);
        }
